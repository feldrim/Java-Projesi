 ...
 *	EmriUygula metodu yazýlacak.
 *	Bugüm ile kýyaslama yok :/
 *
 **/
		...
		switch(secim1){
			case 1:
				...
				if(emirTuru == "temizlik" ){
					emirListesi[emirNo - 1] = new TemizlikEmri(emirNo, verilmeTarihi, uygulamaTarihi, emirVeren, false, temizlikBolgesi, temizlikTuru, temizlikKisiSayisi);
				} else if(emirTuru == "spor" ){
					emirListesi[emirNo - 1] = new SporEmri(emirNo, verilmeTarihi, uygulamaTarihi, emirVeren, false, sporAciklama, sporTekrar);
				}
				
				System.out.println("Emir Kaydedildi:\n"+ emirListesi[emirNo -1 ].toString());
			...
			case 2:
				if(emirSayisi == 0){
					...
					for(i = 0 ; i < emirSayisi; i++){
						System.out.println(emirListesi[i].toString());
					}
				}
				break;
			...
			do{
				...
				System.out.println(" Listeye eklendi: " + komutanListesi[komutanSayisi].toString());
				komutanSayisi++;			
				break;
			...
			case 4:
				...
				for (i = 0 ; i < komutanSayisi; i++){
					System.out.println( komutanListesi[i].toString() );
				}
				break;
			default:
